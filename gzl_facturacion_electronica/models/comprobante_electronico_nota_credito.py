...
class FacturacionElectronica(models.Model):
    ...
    def validarComprobanteNotaCredito(self):
        objValidarFactura=self.env.ref('gzl_facturacion_electronica.url_servicio_validar_nota_credito')
    ...
    def procesarDocumentoNotaCredito(self):
        dctCodDoc={
        ...
        objProcesarFactura=self.env.ref('gzl_facturacion_electronica.url_servicio_procesar_nota_credito')
...
###################################################
       ...
       # dctFactura['rise']= ""
        ...
        body_pf={'notasCredito':[dctFactura]}
    ...
    def descargarXMLNotaCredito(self, encoding='utf-8'):
        objdescargarXML=self.env.ref('gzl_facturacion_electronica.url_servicio_descargar_xml_nota_credito')
    ...
    def descargarRideNotaCredito(self, encoding='utf-8'):
        objdescargarRide=self.env.ref('gzl_facturacion_electronica.url_servicio_descargar_ride_nota_credito')
