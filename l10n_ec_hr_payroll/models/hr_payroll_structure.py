...
result = -(400.0/12.0/30 *days)''',
            ...
            (0, 0, {
             ...
             (0, 0, {
                ...
                "appears_on_payslip":False,
                "condition_select":'python',
                "condition_python":'result = not employee.mensualize_fr and employee.has_13months(payslip.date_from)',
                "amount_select":'code',
                "amount_python_compute":'''days = worked_days.WORK100.number_of_days
result = -(categories.APOR * 8.33 /100)'''
            }),
            (0, 0, {
                "code":'FR',
                ...
                "appears_on_payslip":True,
                "condition_select":'python',
                "condition_python":'result = employee.mensualize_fr and employee.has_13months(payslip.date_from)',
                "amount_select":'code',
                "amount_python_compute":'''days = worked_days.WORK100.number_of_days
result = (categories.APOR * 8.33 /100)'''
            }),
...
result = -(categories.APOR /24)'''
            ...
            (0, 0, {
                "code":'IESSPERV',
                "name":'Aporte IESS Personal por Vacaciones',
                "category_id": self.env.ref("l10n_ec_hr_payroll.rule_cat_APTES"),
                "sequence":900,
                "appears_on_payslip":True,
                "condition_select":'python',
                ...
                "amount_select":'code',
                "amount_python_compute":'result = ((VACATIONS) * 9.45 / 100) * -1'
            }),
            (0, 0, {
                "code":'IESSPATV',
                "name":'Aporte IESS Patronal por Vacaciones',
                "category_id": self.env.ref("l10n_ec_hr_payroll.rule_cat_APTES"),
                "sequence":901,
                "appears_on_payslip":False,
                "condition_select":'python',
                "condition_python":'result = worked_days.VACATION100',
                "amount_select":'code',
                "amount_python_compute":'result = -(VACATIONS) * 12.15 / 100'
            }),
            (0, 0, {
                "code":'VACATIONS',
                "name":'Vacaciones',
                "category_id": self.env.ref("l10n_ec_hr_payroll.rule_cat_vacation"),
                "sequence":2,
                "appears_on_payslip":True,
                "condition_select":'python',
                "condition_python":'result = worked_days.VACATION100',
...
result = worked_days.VACATION100 and days * (contract.wage/30)'''
            }),
            (0, 0, {
                "code":'Enfermedad',
...
if days <=3:
    result = worked_days.LEAVE110 and days * (contract.wage/30)
else:
    result = worked_days.LEAVE110 and days * (contract.wage/30) * 0.25'''
            })]
        return data
