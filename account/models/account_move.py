...
class AccountMove(models.Model):
    ...
    def get_sale_types(self, include_receipts=False):
        return ['out_invoice', 'out_refund','out_debit'] + (include_receipts and ['out_receipt'] or [])
    ...
    def get_outbound_types(self, include_receipts=True):
        return ['in_invoice', 'out_refund','liq_purchase','in_debit'] + (include_receipts and ['in_receipt'] or [])
